...
Future<void> configureDependencies() async {
  ...
  getIt.registerFactory(() => AdminDashboardCubit(dashboardRepository: getIt()));
  getIt.registerFactory(() => TeacherDashboardCubit(dashboardRepository: getIt()));
  ...
  getIt.registerFactory(() => AvailabilityCubit(availabilityRepository: getIt()));
